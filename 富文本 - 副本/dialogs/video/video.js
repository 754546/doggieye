...
(function(){
    ...
    function createPreviewVideo(url){
        ...
        if (url.startsWith("http") && url.indexOf(".mp4") > 0) {
            ...
            ' width="' + 420  + '"' +
            ' height="' + 280  + '"' +
            ' play="true" loop="false" data-setup="{}" controls="controls" preload="auto" poster="http://pic.doggieye.com/20191204/bccbd743d44d4612ac2420651b48bdf3.jpeg">' +
            '</video>';
        }
    ...
    function insertUpload(){
        ...
        for(var key in uploadVideoList) {
			...
			// console.log(uploadVideoList[key])
        ...
        initUploader: function () {
            ...
            function addFile(file) {
                ...
                if (file.getStatus() === 'invalid') {
                    ...
                    /* 检查文件格式 */
                    if (!file.ext || acceptExtensions.indexOf(file.ext.toLowerCase()) == -1&&file.ext!='mp3') {
